...
// Slide-out cart drawer — UI only for now.
// TODO: wire "שלם עכשיו" up to a real payment provider (e.g. Tranzila/Cardcom/Stripe).
      ...
      >
        ...
        {isPaid ? (
          <div className="flex flex-1 flex-col items-center justify-center gap-3 p-8 text-center">
            <p className="text-2xl font-semibold text-navy-950">תודה רבה! 🙌</p>
            <p className="font-normal text-navy-700/70">ניצור איתך קשר לאישור התרומה ופרטי התשלום.</p>
            <button
              type="button"
              onClick={handleClose}
              className="mt-4 border-4 border-black bg-navy-900 px-6 py-3 text-sm font-semibold text-cream uppercase shadow-brutal transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-brutal-none"
            >
              סגירה
            </button>
          </div>
