...
export default function DonationTierCard({ tier, index }: { tier: DonationTier; index: number }) {
  ...
  return (
    <div className="flex h-full flex-col justify-between gap-6 border-4 border-black bg-cream p-7 shadow-brutal-lg transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-brutal-none">
      <div>
