...
// the compact Contact-page StaffCard, with room for a full description
// alongside the photo. Entrance is orchestrated by the parent grid's
// stagger container.
  ...
  return (
    ...
    >
      <div className="relative shrink-0 self-center sm:self-start">
        ...
        />
        <div className={`flex h-32 w-32 items-center justify-center overflow-hidden border-4 border-black ${ACCENTS[index % ACCENTS.length]}`}>
          {staff.imageUrl ? (
      ...
      <div className="text-center sm:text-right">
        ...
        {staff.description && <p className="mt-3 text-sm font-normal text-navy-700/80">{staff.description}</p>}
      </div>
    </motion.div>
  );
}
