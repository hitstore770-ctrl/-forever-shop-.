...
const HEIGHT_BY_SIZE: Record<GalleryPhoto["size"], string> = {
  sm: "h-48",
  md: "h-64",
  lg: "h-80",
};
...
// wall. Real uploaded photos (imageUrl set) render as cover images; seed
// placeholders fall back to a captioned camera tile.
          ...
          >
            {photo.imageUrl ? (
              ...
              <img
                ...
                alt={photo.caption}
                loading="lazy"
                className={`w-full ${HEIGHT_BY_SIZE[photo.size]} object-cover`}
              />
            ) : (
              <div
