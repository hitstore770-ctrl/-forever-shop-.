    ...
    >
      ...
      <input
        ...
        style={{
          ...
          background: focus ? "rgba(255,254,250,0.92)" : "rgba(255,254,250,0.6)",
          backdropFilter: "blur(16px) saturate(150%)",
          border: `1px solid ${focus ? GOLD.base + "80" : GOLD.base + "2E"}`,
          boxShadow: focus
            ? `0 8px 26px ${GOLD.base}26`
            : "0 4px 16px rgba(59,47,20,0.04)",
          transition:
            "background 0.6s ease, border-color 0.6s ease, box-shadow 0.6s ease",
        }}
      />

      {/* soft gold underline sweep */}
      <motion.div
        initial={false}
...
function FormSection() {
  ...
  return (
    <section id="form" className="relative z-10 px-5 pb-40 sm:px-10 lg:px-16">
      <div className="mx-auto max-w-4xl">
        <div
          ...
          style={{
            ...
            border: `1px solid ${GOLD.base}3D`,
            boxShadow: "0 24px 70px rgba(59,47,20,0.1)",
          }}
        >
          {/* top gold edge */}
          <div className="absolute inset-x-0 top-0 h-[2px]" style={{ background: GOLD_GRADIENT }} />

          {/* soft corner glow */}
          <div
            className="pointer-events-none absolute -left-16 -top-16 h-56 w-56 blur-3xl"
            style={{ background: `${GOLD.base}1F` }}
          />
          ...
          <AnimatePresence mode="wait">
            {!sent ? (
              ...
              <motion.div
                ...
                className="flex flex-col items-start gap-6 p-8 sm:flex-row sm:items-center sm:gap-8 sm:p-12"
                style={{
                  background: `${GOLD.light}2E`,
                  border: `1px solid ${GOLD.base}4D`,
                }}
              >
                <motion.div
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: FONT_BODY, color: `${GOLD.ink}A6` }}
                  >
        ...
        {/* minimal sign-off — no traditional footer */}
        <motion.p
          initial={{ opacity: 0 }}
          ...
          style={{ fontFamily: FONT_BODY, fontWeight: 600, color: `${GOLD.ink}66` }}
        >
...
function MainContent({ video }: { video?: WeeklyVideo }) {
  return (
    <main
      ...
      style={{
        background:
          "linear-gradient(180deg, #FFFEFA 0%, #FDFBF4 38%, #FBF7EC 72%, #FFFEFA 100%)",
      }}
    >
...
export default function Page() {
  ...
  // CMS hook-up point — replace with your fetched data later
  const weeklyVideo: WeeklyVideo | undefined = useMemo(
    () => ({
      // src: "/videos/weekly.mp4",
      // poster: "/videos/weekly-poster.jpg",
  ...
  return (
    ...
    >
      <style>{`
        ...
        input::placeholder { color: ${GOLD.ink}4D; }
